...
import TagComponent from '@/components/website/tag'
import TicketForm from '@/components/website/ticket-form'
                  ...
                  <CardFooter className="m-0 p-2 border-t-[1px] border-muted-foreground/20 flex items-center justify-between">
                    <div className="flex item-center gap-2">
                      <Avatar className="w-8 h-8">
                        ...
                        />
                        <AvatarFallback className="bg-[#A64D79] text-sm text-black">
