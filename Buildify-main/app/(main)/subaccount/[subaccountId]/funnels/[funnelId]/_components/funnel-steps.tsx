...
import CreateFunnelPage from '@/components/website/funnel-page'
                ...
                <CardDescription className="flex flex-col gap-4">
                  <div className="border-2 rounded-lg sm:w-80 w-full  overflow-clip">
                    ...
                    <Link
                      ...
                      className="group flex items-center justify-start p-2 gap-2 hover:text-[#A64D79] transition-colors duration-200"
                    >
