...
import CircleProgress from '@/components/website/circle-progress'
import PipelineValue from '@/components/website/pipeline-value'
import SubaccountFunnelChart from '@/components/website/subaccount-funnel-chart'
            ...
            <Card>
              <CardHeader>
                ...
                <Link
                  ...
                  className="text-white bg-gradient-to-r from-purple-500 to-pink-500 hover:bg-gradient-to-l focus:ring-4 focus:outline-none focus:ring-purple-200 dark:focus:ring-purple-800 font-medium p-2 w-fit  rounded-md flex items-center gap-2"
                >
                  <ClipboardIcon />
                  Launch Pad
                </Link>
        ...
        <div className="flex flex-col gap-4 pb-6">
          ...
          <div className="flex gap-4 flex-col xl:!flex-row">
            ...
            <Card className="p-4 flex-1">
              ...
              <AreaChart
                className="text-sm stroke-[#A64D79]"
                data={sessions || []}
                index="created"
